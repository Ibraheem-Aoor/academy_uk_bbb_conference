                            ...
                            <div class="col-12 mt-4">
                                <div class="card pricing-rates business-rate shadow border-0 rounded">
                                    <div class="ribbon ribbon-right ribbon-warning overflow-hidden"><span
                                            class="text-center d-block shadow small h6">Current</span></div>
                                    <div class="card-body">
                                        <h6 class="title fw-bold text-uppercase text-primary mb-4">{{ $plan->type }}</h6>
                                        ...
                                        <ul class="list-unstyled mb-0 ps-0">
                                            ...
                                            <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                        class="uil uil-check-circle align-middle"></i></span>{{ $user->rooms()->sum('max_meetings') }}
                                                Meetings</li>
                                            <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                        class="uil uil-check-circle align-middle"></i></span>{{ $user->rooms()->sum('max_participants') }}
                                                Participants</li>
                                            <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                        class="uil uil-check-circle align-middle"></i></span>{{ $plan->max_storage_allowed }}
                                                GB Storage</li>
                                            @if ($plan->is_backup_enabled)
                                                <li class="h6 text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                            class="uil uil-check-circle align-middle"></i></span>Auto Backup
                                                    </li>
                                            @endif
                                        </ul>
