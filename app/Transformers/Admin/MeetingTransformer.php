...
class MeetingTransformer extends TransformerAbstract
{
    ...
    public function getStatusColumn($meeting)
    {
        ...
        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="status"  ' . $is_checked . ' data-route="' . route('admin.meeting.toggle_status') . '" data-id="' . $meeting->id . '" onclick="toggleStatus($(this));">
    </div>';
        return $html;
    }
